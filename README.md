...
The Zomato Restaurant Analysis Dashboard is a Power BI project that analyzes global restaurant data to provide insights into ratings, cuisines, 
delivery services, and costs, helping support data-driven business decisions.
# short Description
This project focuses on transforming raw restaurant data from multiple Excel files into a clean, interactive, and insightful Power BI dashboard.
The report allows users to explore restaurant statistics worldwide, analyze customer ratings, identify top-performing restaurants, 
...
Compare restaurant costs across countries and cities
Understand customer preferences and service trends
...
Navigate from continent level to country level
Drill down into cities and individual restaurants
Analyze restaurant distribution geographically

✅ Responsive Multi-Page Report
...
Gauge Charts - Rating and cost analysis
Line/Area Charts -	Average ratings by restaurant
Treemap	- Rating color distribution
...
Identify restaurants with the highest and lowest ratings globally.

🔹 Cost Analysis
Compare average dining costs across countries and cities.

🔹 Customer Preference Analysis
Analyze customer behavior through ratings, cuisines, and service preferences.
...
Monitor global restaurant performance
Improve customer satisfaction
Analyze restaurant service trends
...
Improve restaurant service strategies
Identify high-performing restaurant categories
